...
def main():
    ...
    #better_draw_circles(rg.Point(-200, 0),4)
    #even_better_draw_circles(rg.Point(100,50), 10, 12, 'blue', 5)
    #even_better_draw_circles(rg.Point(10, 100), 20, 7, 'red', 8)
    even_better_draw_circles(rg.Point(0, 0), 12, 7, 'yellow', 8)
    even_better_draw_circles(rg.Point(150, 150), 14, 7, 'red', 8)
    even_better_draw_circles(rg.Point(150, 0), 14, 7, 'red', 8)
    even_better_draw_circles(rg.Point(0, 150), 14, 7, 'red', 8)
    even_better_draw_circles(rg.Point(-150, -150), 14, 7, 'red', 8)
    window.update()
...
def better_draw_circles(point,radius_var):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radius_var)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radius_var * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,radius_var,number_circles,pencolor,penthick):
    turtle = rg.SimpleTurtle()
    turtle.pen=rg.Pen(pencolor,penthick)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)
    for k in range(1, number_circles):
        ...
        turtle.pen_down()
        turtle.draw_circle(radius_var * k)
